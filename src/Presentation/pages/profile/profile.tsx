...
const Profile = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4">
      <div className={`${cardBg} rounded-lg shadow-xl p-8 w-full max-w-md`}>
        <h1 className="text-xl font-bold mb-8 text-center">Profile Settings</h1>
        
        <div className="space-y-6">
          {/* Theme Toggle */}
          <div className="space-y-3">
            <label className={`block text-sm font-medium ${textColor}`}>Theme</label>
            <button
              onClick={toggleTheme}
          ...
          <div className="space-y-3">
            ...
            <div className={`w-full px-4 py-3 rounded-lg border ${inputBg} ${textColor}`}>
          ...
          {/* Role Display */}
          <div className="space-y-3">
            <label className={`block text-sm font-medium ${textColor}`}>Role</label>
            <div className={`w-full px-4 py-3 rounded-lg border ${inputBg} ${textColor} capitalize`}>
        ...
        <div className={`mt-6 p-4 rounded-lg ${theme === 'dark' ? 'bg-gray-700' : 'bg-gray-100'} text-sm`}>
          <p className={`font-semibold mb-2 ${textColor}`}>Account Information</p>
